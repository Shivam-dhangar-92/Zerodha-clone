    ...
    <div className="container mt-5 border-top" >
      <div className="row mt-5">
        ...
        <div className="col">
          ...
          <a className="text-muted " style={{ textDecoration:"none"}}>Support portal</a>
          <br />
          <a className="text-muted " style={{ textDecoration:"none"}}>Z-Connect blog</a>
          <br />
          <a className="text-muted " style={{ textDecoration:"none"}}>List of charges</a>
          <br />
          <a className="text-muted " style={{ textDecoration:"none"}}>Downloads & resources</a>
          <br />
        </div>
        <div className="col">
          <p>Account</p>
